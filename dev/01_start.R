...
golem::fill_desc(
  ...
  authors = person(
    ...
    email = "annaclaire.marley@erg.com", # Your email
    role = c("aut", "cre") # Your role (here author/creator)
  ),
  repo_url = "https://github.com/Eastern-Research-Group/climate_indicator_projections.git", # The URL of the GitHub repo (optional),
